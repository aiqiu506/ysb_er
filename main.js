...
Vue.prototype.iconView={};
Vue.prototype.CreateIcon = function() {
	// 设置水平居中位置
	var bitmap=null;
	...
	var leftPos = Math.ceil((plus.screen.resolutionWidth - 60) / 2);
	 Vue.prototype.iconView = new plus.nativeObj.View('icon', {
		bottom: '19px',
		left: leftPos + 'px',
		width: '60px',
		height: '60px'
	});
	Vue.prototype.iconView.drawBitmap(bitmap, {
		tag: 'font',
		id: 'icon',
	...
	Vue.prototype.iconView.addEventListener(
		'click',
		function(e) {
			uni.switchTab({
				url: '../../pages/index/map'
